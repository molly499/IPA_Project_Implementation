...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', type=str, default='./datasets/SYS', help='Dataset path')
        ...
        parser.add_argument('--dataset_size', type=int, default=970, help='train dataset size')
        parser.add_argument('--maxepoch', type=int, default=150, help='Maximum training epoch')
